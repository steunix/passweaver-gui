  ...
  if (body.data.length) {
    ...
    for (const itm of body.data) {
      row +=
        ...
        '<td>' +
        `<wa-button id='edituser-${itm.id}' data-id='${itm.id}' title='Edit user' appearance='plain' size='s'><wa-icon label='Edit user' name='edit'></wa-icon></wa-button>` +
        `<wa-button id='activity-${itm.id}' data-id='${itm.id}' title='User activity' appearance='plain' size='s'><wa-icon label='User activity' name='clock'></wa-icon></wa-button>` +
        `<wa-button id='folders-${itm.id}' data-id='${itm.id}' title='Visible folders' appearance='plain' size='s'><wa-icon label='Visible folders' name='folder-tree'></wa-icon></wa-button>` +
        `<wa-button id='removeuser-${itm.id}' data-id='${itm.id}' title='Delete user' appearance='plain' size='s'><wa-icon label='Delete user' name='trash' style='color:red;'></wa-icon></wa-button>` +
        '</td>' +
...
async function fillGroups () {
  ...
  if (body.data.length) {
    ...
    for (const itm of body.data) {
      ...
      if (itm.id !== 'E') {
        row += `<td><wa-button id='removegroup-${itm.id}' data-id='${itm.id}' appearance='plain' size='s'><wa-icon name='trash' style='color:red;' label='Remove group'></wa-icon></wa-button></td>`
      } else {
        row += '<td></td>'
      }
