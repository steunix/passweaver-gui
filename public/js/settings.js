...
async function fillItemTypes () {
  ...
  for (const itm of body.data) {
    row +=
      ...
      `<td><wa-icon id='edititemtype-${itm.id}' title='Edit item type' name='edit' data-id='${itm.id}'></wa-icon></td>` +
      `<td class='border-end'><wa-icon id='removeitemtype-${itm.id}' title='Delete item type' name='trash' style='color:red;' data-id='${itm.id}'></wa-icon></td>` +
